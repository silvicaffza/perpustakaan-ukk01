...
<head>
    ...
    <title>@yield('title', 'Admin') - Perpustakaanku</title>
    ...
    <div class="app">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav">
                ...
                @php
                    $akunActive = request()->is('petugas*') || request()->is('account-user*');
                @endphp
                    ...
                    <summary class="dd-sum {{ $akunActive ? 'active' : '' }}">
                        <span>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <path d="M17 11V7M20 9H14" />
                                <path d="M3 21C3 16 7 14 9 14C11 14 15 16 15 21" />
                            </svg>
                        ...
                        <a href="{{ route('petugas.index') }}" class="{{ request()->is('petugas*') ? 'active' : '' }}">
                            <span>
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <path d="M5.5 21C5.5 16.5 9 14 12 14C15 14 18.5 16.5 18.5 21" />
                                </svg>
                                <span class="nav-text">Akun Petugas</span>
                            </span>
                        </a>
                ...
                @php
                    $bukuActive = request()->is('categories*') || request()->is('books*') || request()->is('reviews*');
                @endphp
                ...
                <details class="dd" {{ $bukuActive ? 'open' : '' }}>
                    ...
                    <div class="dd-item">
                        ...
                        <a href="{{ route('books.index') }}"
                            class="{{ request()->is('books*') ? 'active' : '' }}"><span>
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2">
                                    <path d="M4 19.5V4.5A2.5 2.5 0 016.5 2H20V22H6.5A2.5 2.5 0 014 19.5Z" />
                                </svg>
