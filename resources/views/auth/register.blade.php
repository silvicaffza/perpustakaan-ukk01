...
<body>
    ...
    <div class="auth-form">
        ...
        <div class="form-box">
            ...
            <div class="auth-sub">Buat akun perpustakaan</div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="password-wrapper">
                        ...
                        <span class="toggle-pass" onclick="togglePass('confirm')">👁</span>
                    </div>
    ...
    <div class="auth-image">
        ...
        <div class="auth-text">
            ...
            <p>
                Temukan buku menarik dan nikmati pengalaman membaca
                yang lebih mudah di perpustakaan digital kami.
            </p>
        </div>
